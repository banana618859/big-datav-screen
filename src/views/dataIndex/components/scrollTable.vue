...
export default {
  ...
  methods: {
    scrollInit() {
      let that = this
      // let height = $('.scrollContent1')[0].clientHeight-2;
      let height = $('.scrollTableBody')[0].clientHeight;
      console.error('height',height);
      // $('.scrollTable').css({'height':height+'px'})
